window.onload = function () {
    ...
    let lots = [
        ...
        },
        {
            lot: "任",
            py: "rèn",
            sign: "汪年里，做你想做，吃你爱吃，任性。"
        },
        {
            lot: "放",
            py: "fàng",
            sign: "不要浪费时间在错的路上，活出自己。"
        }, {
            lot: "醉",
            py: "zuì",
            sign: "喝最烈的酒，过最灿烂的人生，旺出精彩。"
        },
        {
            lot: "勇",
            py: "yǒng",
    ...
    var url = 'https://www.rokid.com/getWX?url=' + encodeURIComponent(location.href.split('#')[0]);
        ...
        success: function (res) {
            ...
            wx.ready(function () {
                wx.onMenuShareTimeline({
                    title: '这个新年签深得朕的心意',
                    link: 'https://www.rokid.com/chunjie/h5.html',
                    imgUrl: 'https://www.rokid.com/chunjie/share.png',
                    sucess: function () {
                        console.log('分享朋友圈成功');
                    },
                    cancel: function () {
